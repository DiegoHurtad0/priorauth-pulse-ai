 ...
 * Uses Claude Opus 4.6 via the backend to write a peer-to-peer review letter.
 */
          ...
          {!letter && !loading && (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-slate-400 text-sm max-w-sm mb-6">
                Claude Opus 4.6 will write a clinically precise appeal letter citing
        ...
        {letter && (
          <div className="flex items-center justify-between p-4 border-t border-slate-800 gap-3">
            <p className="text-slate-500 text-xs">
              Generated by Claude Opus 4.6 &mdash; review before sending
            </p>
