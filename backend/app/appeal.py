"""
appeal.py — AI-powered PA appeal letter generator using Claude claude-opus-4-6.
...
async def generate_appeal_letter(
    ...
    """
    Generate a clinical peer-to-peer review appeal letter using Claude claude-opus-4-6.
...
[This letter was generated by PriorAuth Pulse AI — powered by Claude claude-opus-4-6 & TinyFish]"""
